...
UUID=${UUID:-'b63a5ba5-8dce-49d9-a19a-a7c4e488aff7'}
VMESS_WSPATH=${VMESS_WSPATH:-'/b63a5ba5-8dce-49d9-a19a-a7c4e488aff7-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/b63a5ba5-8dce-49d9-a19a-a7c4e488aff7-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/b63a5ba5-8dce-49d9-a19a-a7c4e488aff7-trojan'}
SS_WSPATH=${SS_WSPATH:-'/b63a5ba5-8dce-49d9-a19a-a7c4e488aff7-shadowsocks'}
